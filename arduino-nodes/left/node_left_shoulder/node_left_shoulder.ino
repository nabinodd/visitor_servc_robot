...
#include <stdlib.h>
#include <EEPROM.h>
#define SAMPLE_TIME_RUN 50
/**************************************/
#define ADDR 23 //I2C address
String idString = "node-LeftShoulder-A";
/**************************************/
const int enc_pin = 6;
const int pwm_pin = 3;
const int in1_pin = 9;
...
bool mot_stop = false;
byte mot_pwr_cw = 40;
byte mot_pwr_ccw = 140;

/********************************************/
byte starting_up_pwr = 20;
byte starting_down_pwr = 20;

byte max_up_pwr = 175;
byte max_down_pwr = 110;
