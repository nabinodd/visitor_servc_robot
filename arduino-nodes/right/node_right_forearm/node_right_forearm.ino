...
#include <EEPROM.h>
/**************************************/
#define ADDR 16 //I2C address
String idString = "node-RightForeArm-A";
/**************************************/
const int enc_pin = 6;
const int pwm_pin = 3;
const int in1_pin = 8;
...
void setup()
{
  ...
  pinMode(lmtE_pin, INPUT);
  pinMode(comm_req_pin, OUTPUT);
  digitalWrite(comm_req_pin, HIGH); //set com_req_line
